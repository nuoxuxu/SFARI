...
def main():
    ...
    orf_coord = read_orf(results.orf_coord) # 'ID','len', 'orf_strand', 'orf_frame', 'orf_start', 'orf_end', 'orf_len', 'fickett', 'hexamer', 'coding_score', 'pb_acc', 'orf_rank'
    is_with_stop_codon = is_orf_called_with_stop_codon(results.orf_fasta) # 'ID','has_stop_codon'

    orf_coord = pd.merge(orf_coord, is_with_stop_codon, on ='ID', how = 'left') # # 'ID','len', 'orf_strand', 'orf_frame', 'orf_start', 'orf_end', 'orf_len', 'fickett', 'hexamer', 'coding_score', 'pb_acc', 'orf_rank', 'has_stop_codon'
    gencode = read_gtf(results.gencode_gtf, result_type="pandas") # "seqname", "source", "feature", "start", "end", "score", "strand", "frame", "attribute"
    sample_gtf = read_gtf(results.sample_gtf, result_type="pandas") # "seqname", "source", "feature", "start", "end", "score", "strand", "frame", "attribute"
