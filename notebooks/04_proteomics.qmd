...
temp = lr_bulk.var\
    .with_columns(
        ...
        validatable_orf = pl.col("validatable_orf") & (pl.col("ORF_type_right")=="complete")
    )\
    .select(["structural_category2", "total", "protein_coding", "validatable_orf", "validated_proteomics"])\
    .group_by("structural_category2")\
    .sum()\
    .unpivot(index="structural_category2")\
    .cast({"variable": pl.Enum(["total", "protein_coding", "validatable_orf", "validated_proteomics"])})
```
...
temp = temp\
    ...
    .cast({"variable": pl.Enum(["transcriptomics_only", "in_any_PSMs", "in_novel_only_PSMs"])})
