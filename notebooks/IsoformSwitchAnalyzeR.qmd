...
# Running Pfam_scan
cd ${SCRATCH}/SFARI
/home/s/shreejoy/nxu/tools/PfamScan/pfam_scan.pl -fasta isoformSwitchAnalyzeR_isoform_AA.fasta -dir /home/s/shreejoy/nxu/tools/Pfam_flat_files -cpu 30 -outfile pfam_scan_results.txt
```
...
# To-dos
- Merge the isoformSwitchAnalysis table withc consequences of the switches
