...
# module apptainer
# apptainer exec -e -B="/scratch/nxu/SFARI:/scratch/nxu/SFARI" ~/tools/transdecoder.v5.7.1.simg /usr/local/bin/util/cdna_alignment_orf_to_genome_orf.pl \
...
apptainer exec -e -B="${PWD}:${PWD},/gpfs/fs0/scratch/nxu/SFARI:/gpfs/fs0/scratch/nxu/SFARI" ~/tools/transdecoder.v5.7.1.simg /usr/local/bin/util/cdna_alignment_orf_to_genome_orf.pl \
    merge_collapsed.filtered.fasta.transdecoder.gff3 \
    transcripts.gff3 \
