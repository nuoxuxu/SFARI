...
# Spetember 4th updates:
novel_exonic_regions_CDS_expanded_grl <- rtracklayer::import("export/variant/novel_exonic_regions_CDS_expanded_grl.gtf")
expressed_at_t30 <- read_csv("export/variant/expressed_t30.csv")
subset(novel_exonic_regions_CDS_expanded_grl, mcols(novel_exonic_regions_CDS_expanded_grl)$transcript_id %in% pull(expressed_at_t30, x)) %>% 
    rtracklayer::export("export/variant/novel_exonic_regions_CDS_expanded_grl_expressed_at_t30.gtf")